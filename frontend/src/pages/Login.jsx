      ...
      <div style={{
        ...
        <div style={{ maxWidth: '480px', margin: 'auto 0', zIndex: 2 }}>
          ...
          <p style={{
            ...
            Organize applications, schedule interviews, and track status indicators in one premium workspace. Your next big opportunity starts here.
          </p>
          ...
          <div className="glass-panel" style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                <h4 style={{ color: '#fff', fontSize: '1.1rem' }}>Frontend Architect</h4>
                <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>Stripe, Inc.</p>
              </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.8rem', borderTop: '1px solid var(--border-color)', paddingTop: '12px', color: 'var(--text-muted)' }}>
              <span>Applied: July 05, 2026</span>
              <span style={{ color: 'var(--color-accent-light)' }}>View Link &rarr;</span>
            </div>
          </div>
        </div>
      ...
      <div style={{
        ...
        <div className="glass-panel animate-slide" style={{
          ...
          <p style={{
            ...
            Sign in to access your dashboard and tracked jobs.
          </p>
